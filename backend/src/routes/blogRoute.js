...
import { validateBody, BlogSchema } from '../middleware/validationMiddleware.js';

const blogRouter = express.Router();

blogRouter.post('/create', protect, creatorOnly, upload.single('image'), validateBody(BlogSchema), createBlog);
...
blogRouter.put('/:id', protect, creatorOnly, upload.single('image'), validateBody(BlogSchema), updateBlog);
